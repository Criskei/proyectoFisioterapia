...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <h2 class="font-semibold text-xl text-black leading-tight">Información Paciente</h2>
            ...
            <tablaCRUDLayout>
                ...
                <template #contenidoTabla>
                    <tr v-for="(t, index) in tratamientos " :key="index">
                        ...
                        <contenidoTabla>{{ t.dentista.usuario.nombres ?? null }}</contenidoTabla>
                        <contenidoTabla>{{ t.receta_medica ?? null }}</contenidoTabla>
                        <contenidoTabla>{{ t.tipo_historial.nombre_tipo_historial ?? null }}</contenidoTabla>
        ...
        <cardLayout>
            ...
            <tablaCRUDLayout>
                <template #tituloTabla>
                    ...
                    <tituloTabla>Dentista que lo solicitó</tituloTabla>
                ...
                <template #contenidoTabla>
                    <tr v-for="(d, index) in documentos " :key="index">
                        ...
                        <contenidoTabla>{{ d.dentista.usuario.nombres ?? null }}</contenidoTabla>
