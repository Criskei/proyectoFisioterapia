...
<template>
    ...
    <AuthenticatedLayout>
        <TableCRUDLayout>
            <template #titulo>Fisioterapeutas</template>
            ...
            <template #main>
                <tr v-for="fisioterapeuta in fisioterapeutas" :key="fisioterapeuta.id_fisioterapeuta"
                    ...
                    <td>{{ fisioterapeuta.usuarios.nombres }}</td>
                    <td>{{ fisioterapeuta.usuarios.apellidos }}</td>
                    <td>{{ fisioterapeuta.usuarios.celular }}</td>
                    <td>{{ fisioterapeuta.usuarios.email }}</td>
            ...
            <template #modales>
                ...
                <!-- Read modal -->
                <div id="readModal" tabindex="-1" aria-hidden="true"
                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        ...
                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <div class="flex justify-between mb-4 rounded-t sm:mb-5">
                                <div class="text-lg text-gray-900 md:text-xl dark:text-white">
                                    <h3 class="font-semibold ">Información del perfil</h3>
                                    <p class="font-semibold">Fisioterapeuta</p>
                                </div>
                                <div>
                                    <button type="button"
                            ...
                            <dl>
                                ...
                                <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">Standard glass
                                    ,3.8GHz
                                    8-core 10th-generation Intel Core i7 processor, Turbo Boost up to 5.0GHz, 16GB
                                    2666MHz DDR4
