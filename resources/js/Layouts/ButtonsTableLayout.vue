<template>
    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
        <div class="flex items-center space-x-4">
            <button type="button" id="updateModalButton" data-modal-target="updateModal" data-modal-toggle="updateModal"
            ...
            <button type="button" id="readModalButton" data-modal-target="readModal" data-modal-toggle="readModal"
            ...
            <button type="button" id="deleteModalButton" data-modal-target="deleteModal" data-modal-toggle="deleteModal"
