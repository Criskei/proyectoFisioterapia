<script setup>
import ButtonsTableLayout from './ButtonsTableLayout.vue';
import FooterTableLayout from './FooterTableLayout.vue';
import NameTableLayout from './NameTableLayout.vue';
import OptionsTableLayout from './OptionsTableLayout.vue';
</script>

<template>
    <section class="bg-gray-50 dark:bg-gray-900 p-1 sm:p-1 antialiased">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="px-4 py-3">
                                <span
                                    class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">Listo                                    </span>
                            </td>
