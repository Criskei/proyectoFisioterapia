...
<template>
    ...
    <AuthenticatedLayout>
        <h2 class="font-semibold text-xl text-gray-950 leading-tight">Dentistas</h2>

        <tablaCRUDLayout>
            <template #tituloTabla>
                <tituloTabla>Nombres</tituloTabla>
                <tituloTabla>Apellidos</tituloTabla>
                <tituloTabla>Celular</tituloTabla>
                <tituloTabla>Email</tituloTabla>
                <tituloTabla>Disponibilidad</tituloTabla>
            </template>

            <template #contenidoTabla>
                <tr v-for="(d, index) in dentistas " :key="index">
                    <checkbox />
                    <contenidoTabla>{{ d.usuario.nombres }}</contenidoTabla>
                    <contenidoTabla>{{ d.usuario.apellidos }}</contenidoTabla>
                    <contenidoTabla>{{ d.usuario.celular }}</contenidoTabla>
                    <contenidoTabla>{{ d.usuario.email }}</contenidoTabla>
                    <td>
                        <div v-if="d.disponibilidad == 1" class="flex items-center">
                    ...
                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <div class="flex items-center space-x-4">
                            ...
                            <Link :href="route('dentista.ver', { id: d.dentista_id})"
